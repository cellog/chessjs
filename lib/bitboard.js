...
Bitboard.prototype = {
 ...
 getConnectingRay: function(to, shouldbe) {
  ...
  if (tobit.length > 1) {
   ...
   return tobit.reduce(function(t, b) {
    console.log(_this.getConnectingRay(Bitboard.from64Index(b), shouldbe).debugString("\n"),b,"\n")
    return t = t.orB(_this.getConnectingRay(Bitboard.from64Index(b), shouldbe))
   }, new Bitboard(0,0))
  }
  tobit = tobit[0]
  frombit = frombit[0]
