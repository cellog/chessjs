...
Bitboard.prototype = {
 ...
 fillNortheastOcclusion: function(p) {
  return this.fillOcclusion(p.and(notAFile), this.shr, 9, 18, 36)
 },
 fillSouthwestOcclusion: function(p) {
  return this.fillOcclusion(p.and(notHFile), this.shl, 9, 18, 36)
 },
 ...
 fillNorthwestOcclusion: function(p) {
  return this.fillOcclusion(p.and(notHFile), this.shl, 7, 14, 28)
 },
 ...
 rookMovesEast: function(empty) {
  return this.fillEastOcclusion(empty).andB(this.not())
 },
 rookMovesWest: function(empty) {
  return this.fillWestOcclusion(empty).andB(this.not())
 },
