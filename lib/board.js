...
function board(setup) {
 this.bitboards = {
  ...
  set p(t) {this.black[0] = new Bitboard(t)},
  set P(t) {this.white[0] = new Bitboard(t)},
  set r(t) {this.black[1] = new Bitboard(t)},
  set R(t) {this.white[1] = new Bitboard(t)},
  set n(t) {this.black[2] = new Bitboard(t)},
  set N(t) {this.white[2] = new Bitboard(t)},
  set b(t) {this.black[3] = new Bitboard(t)},
  set B(t) {this.white[3] = new Bitboard(t)},
  set q(t) {this.black[4] = new Bitboard(t)},
  set Q(t) {this.white[4] = new Bitboard(t)},
  set k(t) {this.black[5] = new Bitboard(t)},
  set K(t) {this.white[5] = new Bitboard(t)},
 }
}
