  ...
  switch (p) {
   case Pawn:
    ...
    if (captures) {
     ...
     if (startingSquare.length == 2 && squares[1] != startingSquare) {
      throw new InvalidMoveError('Pawn capture from "' + startingSquare + '" to "' + landing + '" is impossible')
     }
     return squares[1]
    } else {
