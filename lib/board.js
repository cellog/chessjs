...
function board(setup) {
 ...
 this.pieces = {
  white: {
   pawns: [new Vector(0,1), new Vector(1,1), new Vector(2,1), new Vector(3,1), new Vector(4,1), new Vector(5,1), new Vector(6,1)],
   rooks: [new Vector(0,0), new Vector(7,0)],
   knights: [new Vector(1,0), new Vector(6,0)],
   bishops: [new Vector(2,0), new Vector(5,0)],
   queens: [new Vector(3,0)],
   king: new Vector(4,0)
  },
  black: {
   pawns: [new Vector(0,6), new Vector(1,6), new Vector(2,6), new Vector(3,6), new Vector(4,6), new Vector(5,6), new Vector(6,6)],
   rooks: [new Vector(0,7), new Vector(7,7)],
   knights: [new Vector(1,7), new Vector(6,7)],
   bishops: [new Vector(2,7), new Vector(5,7)],
   queens: [new Vector(3,7)],
   king: new Vector(4,7)
  }
 }
 this.bitboards = {
...
board.prototype = {
 ...
 getCheckingLanes: function(asVector) {
  var whitesturn = this.turn == 'white',
      ...
      vectorking = this.pieces[this.turn][King],
