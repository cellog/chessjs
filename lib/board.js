...
var m = {
 shl: function(b) {
  return new mini(this.l << b, (this.h << b) | (this.l >>> 32-b))
 },
 shr: function(b) {
  return new mini((this.l >>> b) | (this.h << 32-b), this.h >>> b)
 },
 and: function(a) {
  return new mini(this.l & a, this.h & a)
 },
 or: function(a) {
  return new mini(this.l | a.l, this.h | a.h)
 }
}
function mini(l,h) {
 this.l = l
...
Bitboard.prototype.knightJumps = function() {
 var m = new mini(this.low, this.high),
     ...
     h1 = l1.or(r1),
     h2 = l2.or(r2),
     res = h1.shl(16).or(h1.shr(16)).or(h2.shl(8)).or(h2.shr(8))
 
 return new Bitboard(res.l, res.h, this.piece)
}

Bitboard.prototype.kingMoves = function() {
 var m = new mini(this.low, this.high),
     h = m.shr(1).and(notAFile).or(m.shl(1)).and(notHFile),
     v = m.shl(8).or(m.shr(8)),
     res = h.shl(8).or(h).or(h.shr(8)).or(v)
 return new Bitboard(res.l, res.h, this.piece)
}